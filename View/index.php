...
<body style="background-color: #c1c0c0;">
    <div class="container w-75 h-100" style="background-color: white;">
        ...
        <h4 class="cor_pessoa text-center mt-3">Olá, Gustavo!</h4>
        ...
        <div class="text-center pt-5 d-flex pb-3">
            ...
            <button type="button" class="btnUltra" style="background-color: #ab4894;border-color:#ab4894">Enviar pesquisa</button>
        </div>
    </div>
</body>
